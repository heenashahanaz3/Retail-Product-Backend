...
public class CatlogModel {
	...
	public CatlogModel(long id, String name, float price, String dateoflaunch, String category, boolean freedelivery,
			String description, String imageurl, String categoryimageurl) {
		super();
		this.id = id;
		this.name = name;
		this.price = price;
	...
	public String toString() {
		return "CatlogModel [id=" + id + ", name=" + name + ", price=" + price + ", dateoflaunch=" + dateoflaunch
